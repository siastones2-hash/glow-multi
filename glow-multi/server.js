...
async function initDB() {
  ...
  if (true) {
    const svcs = [
      ...
      {id:'pig14',name:'Instagram 좋아요 — 여성 타겟',pl:'instagram',rate:3.5,min:20,max:1000,description:'여성 기반 고품질 Instagram 좋아요 서비스로, 여성 타겟 브랜드 마케팅에 최적화되어 해당 시장 타겟 마케팅에 최적화되어 있습니다. 좋아요가 많은 게시물은 알고리즘이 인기 게시물로 분류하여 팔로워 외 사용자의 탐색 탭에도 대규모 노출됩니다. 유기적 도달 범위를 빠르게 확장하는 가장 효과적인 방법입니다.',api_id:'14251'},
      ...
      {id:'pig22',name:'Instagram 릴스 좋아요 — 프리미엄 글로벌',pl:'instagram',rate:0.24,min:20,max:20000,description:'전 세계 실계정 기반으로 제공되는 고품질 Instagram 릴스 좋아요 서비스입니다. 릴스 좋아요를 빠르게 늘려 탐색 탭과 릴스 피드 상위 노출을 유도합니다. 좋아요가 많은 릴스는 알고리즘이 더 넓은 사용자층에게 배포하여 팔로워 급증 효과로 이어집니다.',api_id:'17528'},
      ...
      {id:'ptt9',name:'TikTok 저장 — 프리미엄 글로벌',pl:'tiktok',rate:0.01,min:10,max:2147483647,description:'전 세계 실계정 기반으로 제공되는 고품질 TikTok 저장 서비스입니다. 저장 수는 틱톡 알고리즘에서 "다시 보고 싶은 영상" 신호로 높은 가중치를 받습니다. 저장이 많은 영상은 포유 탭에 장기간 지속 노출되어 튜토리얼·정보성 콘텐츠에 특히 효과적입니다.',api_id:'25343'},
      ...
      {id:'pyt2',name:'YouTube 팔로워 — 프리미엄 글로벌 (드롭 보상)',pl:'youtube',rate:41.99,min:50,max:100000,description:'전 세계 실계정 기반으로 제공되는 고품질 YouTube 팔로워 서비스입니다. 유튜브 구독자는 수익화 조건 달성과 채널 신뢰도의 핵심 요소입니다. 구독자가 많을수록 신규 방문자의 구독 전환율이 올라가고, 브랜드 협찬 단가와 광고 수익이 함께 상승합니다. 드롭 발생 시 자동 보상되어 안정적인 장기 운영이 가능합니다.',api_id:'27905'},
      {id:'pyt3',name:'YouTube 팔로워 — 미국 타겟',pl:'youtube',rate:37.51,min:100,max:1000000,description:'미국 기반 고품질 YouTube 팔로워 서비스로, 미국 광고 RPM이 세계 최고 수준이며 해당 시장 타겟 마케팅에 최적화되어 있습니다. 유튜브 구독자는 수익화 조건 달성과 채널 신뢰도의 핵심 요소입니다. 구독자가 많을수록 신규 방문자의 구독 전환율이 올라가고, 브랜드 협찬 단가와 광고 수익이 함께 상승합니다.',api_id:'28717'},
      ...
      {id:'pyt6',name:'YouTube 재생수 — 프리미엄 글로벌 (드롭 보상)',pl:'youtube',rate:0.45,min:10,max:50000,description:'전 세계 실계정 기반으로 제공되는 고품질 YouTube 재생수 서비스입니다. 유튜브 라이브 스트림 참여도를 높입니다. 실시간 방송의 활성도 지표를 개선하여 알고리즘 노출 확률과 시청자 유입을 가속화합니다. 드롭 발생 시 자동 보상되어 안정적인 장기 운영이 가능합니다.',api_id:'19372'},
      ...
      {id:'pfb2',name:'Facebook 댓글 — 프리미엄 글로벌',pl:'facebook',rate:2.1,min:1,max:500000,description:'전 세계 실계정 기반으로 제공되는 고품질 Facebook 댓글 서비스입니다. 게시물에 댓글을 달아 참여도를 높입니다. 댓글이 많은 게시물은 알고리즘이 인기 콘텐츠로 분류하여 뉴스피드 상단 노출이 늘어납니다.',api_id:'29608'},
      ...
      {id:'pfb7',name:'Facebook 좋아요 — 프리미엄 글로벌',pl:'facebook',rate:5.6,min:10,max:250000,description:'전 세계 실계정 기반으로 제공되는 고품질 Facebook 좋아요 서비스입니다. 게시물 좋아요로 페이스북 알고리즘 노출을 높입니다. 좋아요가 많은 게시물은 뉴스피드 상단에 우선 표시되고 친구들에게도 노출되어 유기적 도달이 크게 증가합니다.',api_id:'6320'},
      ...
      {id:'ptg1',name:'Telegram 좋아요 — 프리미엄 글로벌',pl:'telegram',rate:0.09,min:10,max:200000,description:'전 세계 실계정 기반으로 제공되는 고품질 Telegram 좋아요 서비스입니다. 이모지 리액션으로 채널 활성도와 참여율을 높입니다. 리액션이 많은 게시물은 채널의 인게이지먼트 지표를 개선하여 광고주에게 더 매력적인 채널로 보이게 합니다.',api_id:'15396'},
